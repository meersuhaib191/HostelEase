...
<nav class="navbar top-navbar navbar-expand-md">
                <div class="navbar-header" data-logobg="skin6">
                    ...
                    <div class="navbar-brand">
                        ...
                        <b class="logo-icon"><img src="../assets/images/logo-cus.png" alt="homepage" class="dark-logo" /><img src="../assets/images/logo-cus.png" alt="homepage" class="light-logo" /></b><span class="logo-text"><h3 style="color: black; font-family: Arial, Helvetica, sans-serif; font-size: 24px; letter-spacing: 1px; font-weight: bold; display: inline;">HostelEase</h3></span>
